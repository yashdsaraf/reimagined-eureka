...
public class StatsService {
  ...
  @Autowired
  public StatsService(PluginRepository pluginRepository, AppUserRepository appUserRepository, DeveloperRepository developerRepository) {
  ...
  public List<List<String>> getUserPerMonth() {
    ...
    getList(outerList, usersPerMonths);
    return outerList;
  }

  private void getList(List<List<String>> outerList, Iterable<Object[]> usersPerMonths) {
